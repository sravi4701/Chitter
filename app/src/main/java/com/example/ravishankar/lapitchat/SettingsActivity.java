...
//                    .start(this);
//            Log.v("message: ", "ok till 117");
//
//            Log.v("message: ", Integer.toString(requestCode));
//            Log.v("message: ", Integer.toString(CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE));
//            if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
//                Log.v("message: ", "ok till 119");
//
